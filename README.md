...
>**Test Scenario**: The sample [smartui-java.java](https://github.com/LambdaTest/smartui-Java/blob/main/visualui.java) tests a sample website and takes the screenshot of the website in a particular build.
